(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('fileuploadApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-fileuploadApp-error');
                var entityKey = httpResponse.headers('X-fileuploadApp-params');
                if (errorHeader) {
